...
class ProxyChainConfig {
  ...
  /// Протоколы, которые умеют быть узлом. `awg` исполняет только mihomo, а
  /// цепочку собирает xray; `custom` — это целый конфиг со своим роутингом,
  /// `chain` — сама цепочка; вкладывать их некуда.
