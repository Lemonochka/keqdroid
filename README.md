...
Хочешь присоединиться к проекту или разобраться, как он устроен изнутри? Полная
документация — в папке [`docs/`](docs/README.md): онбординг (сборка/запуск/тесты),
архитектура, карта проекта, словарь терминов и список «граблей».
