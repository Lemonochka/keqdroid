...
| Живой трафик/статистика | EventChannel из VpnService | TUN: счётчики адаптера; Proxy: `clash_api` встроенного в keqrnel sing-box |
...
| Системный прокси | — | да (Chromium его уважает, Firefox — нет) |
...
- **Статистика в Proxy-режиме** приходит из `clash_api` ядра, а не со счётчиков
